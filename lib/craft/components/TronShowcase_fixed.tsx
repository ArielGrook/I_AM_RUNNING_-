...
const DEFAULT_TABS: ShowcaseTab[] = [
  {
    id: '1',
    tabTitle: 'РџСЂРµРёРјСѓС‰РµСЃС‚РІР°',
    contentTitle: 'РџРѕС‡РµРјСѓ РІС‹Р±РёСЂР°СЋС‚ РЅР°СЃ',
    contentText:
      'РњС‹ СЃРѕР·РґР°С‘Рј СЂРµС€РµРЅРёСЏ РєРѕС‚РѕСЂС‹Рµ СЂР°Р±РѕС‚Р°СЋС‚ РЅР° СЂРµР·СѓР»СЊС‚Р°С‚. РљР°С‡РµСЃС‚РІРѕ, СЃРєРѕСЂРѕСЃС‚СЊ Рё РЅР°РґС‘Р¶РЅРѕСЃС‚СЊ вЂ” РѕСЃРЅРѕРІР° РєР°Р¶РґРѕРіРѕ РїСЂРѕРµРєС‚Р°.',
  },
  {
    id: '2',
    tabTitle: 'Р¦РµРЅС‹',
    contentTitle: 'РџСЂРѕР·СЂР°С‡РЅС‹Рµ С‚Р°СЂРёС„С‹',
    contentText:
      'РќРёРєР°РєРёС… СЃРєСЂС‹С‚С‹С… РїР»Р°С‚РµР¶РµР№. Р“РёР±РєРёРµ РїР°РєРµС‚С‹ РїРѕРґ Р»СЋР±РѕР№ Р±СЋРґР¶РµС‚. РџР»Р°С‚РёС€СЊ С‚РѕР»СЊРєРѕ Р·Р° СЂРµР·СѓР»СЊС‚Р°С‚.',
  },
  {
    id: '3',
    tabTitle: 'РћРїС‹С‚',
    contentTitle: '5 Р»РµС‚ РЅР° СЂС‹РЅРєРµ',
    contentText:
      'Р—Р° СЌС‚Рѕ РІСЂРµРјСЏ СЂРµР°Р»РёР·РѕРІР°РЅС‹ РґРµСЃСЏС‚РєРё РїСЂРѕРµРєС‚РѕРІ РІ СЂР°Р·РЅС‹С… РЅРёС€Р°С…. РљР°Р¶РґС‹Р№ РїСЂРѕРµРєС‚ вЂ” РЅРѕРІС‹Р№ РѕРїС‹С‚.',
  },
];
...
export const TronShowcase = ({
  tabs = DEFAULT_TABS,
  sectionLabel = 'Р§РўРћ РњР« РџР Р•Р”Р›РђР“РђР•Рњ',
  colorScheme = 'dark',
  accentColor = '#e11d48',
  showGrid = true,
}: {
  ...
  return (
    ...
    >
      {/* Left вЂ” content, 65% (first on mobile) */}
...
const TronShowcaseSettings = () => {
  const {
    ...
    sectionLabel: (node.data.props.sectionLabel as string) ?? 'Р§РўРћ РњР« РџР Р•Р”Р›РђР“РђР•Рњ',
  ...
  const addTab = () => {
    ...
    setProp((p: Record<string, unknown>) => {
      ...
      arr.push({
        id: String(Date.now()),
        tabTitle: 'РќРѕРІС‹Р№ С‚Р°Р±',
        contentTitle: 'Р—Р°РіРѕР»РѕРІРѕРє',
        contentText: 'РћРїРёСЃР°РЅРёРµ.',
      });
      p.tabs = arr;
    });
  };
    ...
    <div className="p-3 space-y-5 text-white">
      ...
      <section>
        ...
        <div className="space-y-2">
          ...
          >
            + Р”РѕР±Р°РІРёС‚СЊ (РјР°РєСЃ {MAX_TABS})
          </button>
        </div>
      </section>
    </div>
