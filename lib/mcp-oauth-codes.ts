/**
 * In-memory OAuth authorization codes for MCP connector (single-user / single-process).
 * Cleared on server restart; sufficient for pm2 single-instance deployments.
 */
