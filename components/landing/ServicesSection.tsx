    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-10">
          {services.map((service, i) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#262626] rounded-xl p-5 sm:p-6 shadow-md border border-gray-100 dark:border-[#525151] hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="relative bg-gradient-to-r from-[#FF6B35] via-[#FF4500] to-[#FF6B35] rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row justify-between items-center gap-6 text-white overflow-hidden"
        >
          {/* Shimmer effect */}
