# Site Settings (SEO) — создание таблицы в Supabase

Ошибка `Could not find the table 'public.site_settings'` значит, что таблица ещё не создана.

## Выполните SQL в Supabase

1. Откройте [Supabase Dashboard](https://supabase.com/dashboard) → ваш проект
2. Перейдите в **SQL Editor**
3. Создайте новый запрос и вставьте содержимое `supabase/migrations/20250220_site_settings.sql`:
...
После этого сохранение SEO-настроек из админки будет работать.
